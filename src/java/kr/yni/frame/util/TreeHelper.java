...
/**
 * tree구조 생성을 도와주는 클래스(easyUI 스크립트 용)
 * 
 * @author YNI-maker
 *
 */
...
public class TreeHelper {
	...
	private static Log log = LogFactory.getLog(TreeHelper.class);
	...
	public static List getTreeData(List treeList, String parent, String child) throws Exception {
    	...
    	return getTreeData(treeList, 0, parent, child, allTreeList, null, null, null, 1, -1);
    }
	...
	public static List getTreeData(List treeList, String parent, String child, int collapse_level) throws Exception {
    	...
    	return getTreeData(treeList, 0, parent, child, allTreeList, null, null, null, 1, collapse_level);
    }
	...
	public static List getTreeData(List treeList, int startIdx, String parent, String child) throws Exception {
    	...
    	return getTreeData(treeList, startIdx, parent, child, allTreeList, null, null, null, 1, -1);
    }
	...
	public static List getTreeData(List treeList, int startIdx, String parent, String child, int collapse_level) throws Exception {
    	...
    	return getTreeData(treeList, startIdx, parent, child, allTreeList, null, null, null, 1, collapse_level);
    }
     ...
     */
	private static List getTreeData(List treeList, int startIdx, String parent, String child, ArrayList allTreeList, String childCode, Map curMap, String call, int level, int collapse_level) throws Exception {
		...
		for(int i=startIdx; i < treeList.size(); i++) {
			...
			if((parentValue.isEmpty() || parentValue.equals(childValue)) && call == null) {
				...
				if(parentValue != null && parentValue.equals(childCode)) {
					...
					//log.debug("2 ==> parent : " + parentValue + " / child : " + childCode + " / childValue = " + childValue + " / leaf = " + leaf + " / depth = " + (level+1));
					...
					getTreeData(treeList, i+1, parent, child, allTreeList, childValue, tMap, "reflection", level+1, collapse_level);
				}
			}
		}
	...
	private static Map createTreeMap(Map tMap, boolean collapse) throws Exception{
        ...
        if(tMap.get("ID") != null) {
        	tMap.put("id", tMap.get("ID"));
        }
        
        if(tMap.get("TEXT") != null) {
        	tMap.put("text", tMap.get("TEXT"));
        }
        
        if(tMap.get("LINK_URL") != null) {
        	tMap.put("url",  tMap.get("LINK_URL"));
        }
